                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: SelectionArea(
                                  child: Text(
                                FFLocalizations.of(context).getText(
                                  'qz9d2aiu' /* Hello there 👋 Please enter yo... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  Function() _navigate = () {};
                                  _model.isSignupFormValid = true;
                                  if (_model.formKey.currentState == null ||
                                      !_model.formKey.currentState!
                                          .validate()) {
                                    safeSetState(
                                        () => _model.isSignupFormValid = false);
                                    return;
                                  }
                              ...
                              child: Row(
                                ...
                                children: [
                                  SelectionArea(
                                      child: Text(
                                    FFLocalizations.of(context).getText(
                                      'i7hw7fwk' /* Already have an account?  */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
