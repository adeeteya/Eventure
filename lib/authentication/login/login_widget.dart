                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: SelectionArea(
                                  child: Text(
                                FFLocalizations.of(context).getText(
                                  'h6nu2jcs' /* Welcome back! Please enter you... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  Function() _navigate = () {};
                                  _model.isLoginFormValid = true;
                                  if (_model.formKey.currentState == null ||
                                      !_model.formKey.currentState!
                                          .validate()) {
                                    safeSetState(
                                        () => _model.isLoginFormValid = false);
                                    return;
                                  }
                                  if (_model.isLoginFormValid == true) {
                              ...
                              child: Row(
                                ...
                                children: [
                                  SelectionArea(
                                      child: Text(
                                    FFLocalizations.of(context).getText(
                                      'gycfdo93' /* Don't have an account?  */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
