...
import 'edit_preview_event_model.dart';
export 'edit_preview_event_model.dart';

class EditPreviewEventWidget extends StatefulWidget {
  const EditPreviewEventWidget({super.key});

  static String routeName = 'EditPreviewEvent';
  static String routePath = '/editPreviewEvent';

  @override
  State<EditPreviewEventWidget> createState() => _EditPreviewEventWidgetState();
}

class _EditPreviewEventWidgetState extends State<EditPreviewEventWidget> {
  late EditPreviewEventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditPreviewEventModel());
                            ...
                            await FFAppState()
                                ...
                                .update(createEventRecordData(
                                  ...
                                  templateHeader: FFAppState()
                                      .eventInputFields
                                      .templateHeader,
                                  templateBody: FFAppState()
                                      .eventInputFields
                                      .templateBody,
                                  templateFooter: FFAppState()
                                      .eventInputFields
                                      .templateFooter,
                                  startDatetime: FFAppState()
                                      .eventInputFields
                                      .startDatetime,
                                  endDatetime:
                                      FFAppState().eventInputFields.endDatetime,
                                  location:
                                      FFAppState().eventInputFields.location,
                                  createdBy:
                                      FFAppState().eventInputFields.createdBy,
                                  createdTime:
                                      FFAppState().eventInputFields.createdTime,
                                ));
