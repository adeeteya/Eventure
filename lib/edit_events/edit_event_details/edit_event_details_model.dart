...
import '/index.dart';
import 'edit_event_details_widget.dart' show EditEventDetailsWidget;
import 'package:flutter/material.dart';

class EditEventDetailsModel extends FlutterFlowModel<EditEventDetailsWidget> {
  ...
  String? _eventTitleInputFieldTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '97h98pu6' /* Enter event title is required */,
      );
    }
  ...
  String? _eventDescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '8m3xuc9f' /* Write your event description i... */,
      );
    }
