...
import 'customize_template_page_model.dart';
export 'customize_template_page_model.dart';

class CustomizeTemplatePageWidget extends StatefulWidget {
  const CustomizeTemplatePageWidget({super.key});

  static String routeName = 'CustomizeTemplatePage';
  static String routePath = '/customizeTemplatePage';

  @override
  State<CustomizeTemplatePageWidget> createState() =>
      _CustomizeTemplatePageWidgetState();
}

class _CustomizeTemplatePageWidgetState
    extends State<CustomizeTemplatePageWidget> {
  late CustomizeTemplatePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomizeTemplatePageModel());

    _model.templateHeaderInputTextController ??= TextEditingController();
    _model.templateHeaderInputFocusNode ??= FocusNode();

    _model.templateBodyInputTextController ??= TextEditingController();
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          't2i87ms8' /* Enter Header Text Here */,
                                        ),
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'a5p82gho' /* Enter Footer Text Here */,
                                        ),
                                        enabledBorder: UnderlineInputBorder(
                                          borderSide: BorderSide(
                                            color: Colors.white,
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.pushNamed(
                          EnterEventDetailsWidget.routeName,
